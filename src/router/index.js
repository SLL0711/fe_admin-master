...
export const asyncRoutes = [
  // 资产管理
  {
    ...
    children: [
      {
        path: 'prodInfo',
        component: () => import('@/views/product/prod/index'),
        name: 'product-prod',
        meta: { permissions: ['admin', 'product-prod'], title: '成品信息', icon: 'server', noCache: true }
      },
      {
        path: 'material',
        component: () => import('@/views/product/material/index'),
        name: 'product-material',
        meta: { permissions: ['admin', 'product-material'], title: '原材料信息', icon: 'el-icon-s-order', noCache: true }
      }
    ]
  },
  // 系统管理
